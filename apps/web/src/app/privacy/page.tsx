      ...
      <main className="mx-auto max-w-3xl px-4 pt-24 pb-20 sm:px-6">
        ...
        <div className="mt-10 space-y-10 text-slate-300">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              We collect: (a) <strong className="text-chrome-text">Account information</strong> you provide (email, name, password); (b) <strong className="text-chrome-text">Connected social account data</strong> from Instagram, YouTube, TikTok, Facebook, X, and LinkedIn: profile info, posts, comments on your posts, direct messages and conversations (for unified inbox), and analytics (views, likes, followers, etc.); (c) <strong className="text-chrome-text">Content and settings</strong> you create (scheduled posts, hashtag sets, brand context for AI Assistant); (d) <strong className="text-chrome-text">Usage and technical data</strong> (how you use the product, IP address, browser type). We do not sell your personal data.
            </p>
          </section>
