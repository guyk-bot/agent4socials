...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-[var(--dark)] text-chrome-text">
      <SiteHeader />
      <main className="mx-auto max-w-3xl px-4 pt-24 pb-20 sm:px-6">
        ...
        <div className="mt-10 space-y-10 text-slate-300">
          <section>
            <h2 className="text-xl font-semibold text-chrome-text">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-chrome-text">2. Data we collect</h2>
            <p className="mt-3 leading-relaxed">
              We collect: (a) <strong className="text-chrome-text">Account information</strong> you provide (email, name, password); (b) <strong className="text-chrome-text">Connected social account data</strong> from Instagram, YouTube, TikTok, Facebook, X, and LinkedIn: profile info, posts, comments on your posts (for keyword comment automation), direct messages and conversations (for unified inbox and welcome/new-follower messages), and analytics (views, likes, followers, etc.); (c) <strong className="text-chrome-text">Content and settings</strong> you create (scheduled posts, hashtag sets, brand context for AI Assistant, automation keywords and reply templates); (d) <strong className="text-chrome-text">Usage and technical data</strong> (how you use the product, IP address, browser type). We do not sell your personal data.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-chrome-text">3. How we use your data</h2>
            <p className="mt-3 leading-relaxed">
              We use your data to provide the Service: scheduling and publishing posts; displaying analytics; unified inbox and replying to messages; comment automation (auto-reply when someone comments a keyword, including optional DM replies on Instagram) and welcome/new-follower messages; hashtag pool and AI Assistant features (e.g. AI-generated post descriptions and reply drafts, powered by OpenAI). We also use data to improve the Service, communicate with you, ensure security and prevent abuse, and comply with legal obligations. We may use aggregated or anonymized data for product improvement. <strong className="text-chrome-text">Google User Data that we send to third-party AI providers is not used to train generalized AI or machine learning models.</strong>
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-chrome-text">4. Sharing and disclosure</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-chrome-text">6. Your rights</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-chrome-text">7. Cookies and similar technologies</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-chrome-text">8. Changes to this policy</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-chrome-text">9. Contact and data deletion</h2>
            <p className="mt-3 leading-relaxed">
