...
const organizationJsonLd = {
  ...
  logo: {
    "@type": "ImageObject",
    url: `${siteUrl.replace(/\/+$/, "")}/logo-192.png?v=23`,
    width: 192,
    height: 192,
  },
};
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon-192.png?v=23", sizes: "192x192", type: "image/png" },
      { url: "/favicon-128.png?v=23", sizes: "128x128", type: "image/png" },
      { url: "/favicon-96.png?v=23", sizes: "96x96", type: "image/png" },
      { url: "/favicon-48.png?v=23", sizes: "48x48", type: "image/png" },
      { url: "/favicon.ico?v=23", sizes: "any", type: "image/x-icon" },
      { url: "/a4s-tab.svg?v=23", type: "image/svg+xml" },
    ],
    apple: [{ url: "/favicon-192.png?v=23", sizes: "192x192", type: "image/png" }],
  },
