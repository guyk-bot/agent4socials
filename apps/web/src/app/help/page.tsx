...
export default function HelpPage() {
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="rounded-2xl border border-neutral-200 bg-white shadow-sm overflow-hidden mb-8">
        <div className="px-6 py-8 sm:px-8 border-b border-neutral-100">
          ...
          <p className="text-neutral-600 text-sm mt-1">
            Find answers about connecting accounts, analytics limitations, inbox rules, and more. Can&apos;t find what you need? Open a support ticket at the bottom.
          </p>
          <Link
            href={`#support-ticket`}
      ...
      <nav className="rounded-xl border border-neutral-200 bg-neutral-50/80 px-4 py-4 mb-8" aria-label="On this page">
        <h2 className="text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-3">On this page</h2>
        <ul className="space-y-1.5 text-sm">
          <li><a href="#connecting-accounts" className="text-indigo-600 hover:text-indigo-700 hover:underline">Connecting accounts</a></li>
          <li><a href="#facebook" className="text-indigo-600 hover:text-indigo-700 hover:underline">Facebook</a></li>
          <li><a href="#instagram" className="text-indigo-600 hover:text-indigo-700 hover:underline">Instagram</a></li>
          <li><a href="#tiktok" className="text-indigo-600 hover:text-indigo-700 hover:underline">TikTok</a></li>
          <li><a href="#twitter-x" className="text-indigo-600 hover:text-indigo-700 hover:underline">X (Twitter)</a></li>
          <li><a href="#youtube" className="text-indigo-600 hover:text-indigo-700 hover:underline">YouTube</a></li>
          <li><a href="#linkedin" className="text-indigo-600 hover:text-indigo-700 hover:underline">LinkedIn</a></li>
          <li><a href="#analytics-limitations" className="text-indigo-600 hover:text-indigo-700 hover:underline">Analytics limitations</a></li>
          <li><a href="#inbox-dms" className="text-indigo-600 hover:text-indigo-700 hover:underline">Inbox &amp; DMs</a></li>
          <li><a href="#features" className="text-indigo-600 hover:text-indigo-700 hover:underline">Features overview</a></li>
          <li><a href="#support-ticket" className="text-indigo-600 hover:text-indigo-700 hover:underline">Support ticket</a></li>
        </ul>
      </nav>

      <article className="space-y-8">
        <section id="connecting-accounts" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">Connecting accounts</h2>
        ...
        <section id="facebook" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">Facebook</h2>
        ...
        <section id="instagram" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">Instagram</h2>
          <p className="text-neutral-600 text-sm leading-relaxed mb-3">
        ...
        <section id="tiktok" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">TikTok</h2>
          <p className="text-neutral-600 text-sm leading-relaxed mb-3">
        ...
        <section id="twitter-x" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">X (Twitter)</h2>
          <p className="text-neutral-600 text-sm leading-relaxed mb-3">
        ...
        <section id="youtube" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">YouTube</h2>
          <p className="text-neutral-600 text-sm leading-relaxed mb-3">
        ...
        <section id="linkedin" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">LinkedIn</h2>
          <p className="text-neutral-600 text-sm leading-relaxed mb-3">
        ...
        <section id="analytics-limitations" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">Analytics limitations</h2>
        ...
        <section id="inbox-dms" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">Inbox &amp; DMs</h2>
          <p className="text-neutral-600 text-sm leading-relaxed mb-3">
        ...
        <section id="features" className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-3">Features overview</h2>
          <ul className="list-disc list-inside text-neutral-600 text-sm space-y-2">
        ...
        <section id="support-ticket" className="rounded-xl border-2 border-indigo-200 bg-indigo-50/50 p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-neutral-900 mb-2">Can&apos;t find what you need?</h2>
          <p className="text-neutral-600 text-sm leading-relaxed mb-4">
            Open a support ticket and we&apos;ll get back to you. Include your account email and a short description of the issue or question.
          </p>
          <a
            href={`mailto:${SUPPORT_EMAIL}?subject=Support%20request%20%7C%20Agent4Socials`}
          ...
          <p className="text-neutral-500 text-xs mt-3">
            Email: <a href={`mailto:${SUPPORT_EMAIL}`} className="text-indigo-600 hover:underline">{SUPPORT_EMAIL}</a>
          </p>
        </section>
      </article>
    </div>
