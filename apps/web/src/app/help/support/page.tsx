        ...
        <div className="px-6 py-8 sm:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[var(--button)] text-chrome-text text-sm font-medium hover:bg-[var(--button-hover)] disabled:opacity-50 disabled:pointer-events-none transition-colors"
            >
              {status === 'sending' ? (
                <>Sending...</>
              ) : (
