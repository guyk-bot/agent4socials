    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="card rounded-2xl overflow-hidden border border-neutral-200/80 shadow-sm">
        <div className="p-4 sm:p-6 space-y-5">
          ...
          {/* Plan / Upgrade on top, profile below (same card styling as before) */}
          <div className="flex flex-col gap-6">
            <div className="w-full min-w-0">
              <div className="flex flex-col justify-center rounded-2xl border border-neutral-200/90 bg-gradient-to-br from-neutral-50 via-white to-violet-50/40 px-4 py-4 sm:px-6 sm:py-4 shadow-sm ring-1 ring-black/[0.03]">
