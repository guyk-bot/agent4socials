...
export default function SupportPage() {
  ...
  const tabs: Array<{ id: Tab; label: string; icon: React.ReactNode }> = [
    { id: 'improve', label: 'Help us improve', icon: <MessageSquarePlus size={16} /> },
    { id: 'ticket', label: 'Open a ticket', icon: <Ticket size={16} /> },
    { id: 'zoom', label: 'Schedule a Zoom call', icon: <CalendarClock size={16} /> },
  ];
