...
export function FacebookOverviewTab({
  ...
  return (
    <div className="max-w-full" style={{ maxWidth: 1200 }}>
      {/* Reminder when date range &gt; 30 days (main Upgrade CTA is at top of analytics in dashboard) */}
      {showWatermark && (
        <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 flex flex-col sm:flex-row sm:items-center gap-3">
          <button
            ...
            className="shrink-0 w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 rounded-lg bg-gradient-to-r from-[#5ff6fd] to-[#b030ad] text-neutral-900 font-semibold text-sm hover:opacity-90 transition-opacity"
          >
            Upgrade
          </button>
