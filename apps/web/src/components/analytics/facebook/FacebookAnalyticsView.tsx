    ...
    <div className="rounded-[20px] p-5" style={{ background: COLOR.card, boxShadow: '0 2px 20px rgba(15,23,42,0.06)' }}>
      ...
      <div className="mt-3 h-[300px] pb-5 relative">
        <div className="pointer-events-none absolute inset-0 z-0" aria-hidden>
          <span className="absolute left-[1.5%] top-[14%] text-[15px] font-semibold tracking-wide" style={{ color: 'rgba(102,112,133,0.24)' }}>Agent4Socials</span>
          <span className="absolute right-[1.5%] top-[14%] text-[15px] font-semibold tracking-wide" style={{ color: 'rgba(102,112,133,0.24)' }}>Agent4Socials</span>
          ...
          <span className="absolute left-[1.5%] bottom-[8%] text-[15px] font-semibold tracking-wide" style={{ color: 'rgba(102,112,133,0.24)' }}>Agent4Socials</span>
          <span className="absolute right-[1.5%] bottom-[8%] text-[15px] font-semibold tracking-wide" style={{ color: 'rgba(102,112,133,0.24)' }}>Agent4Socials</span>
        </div>
