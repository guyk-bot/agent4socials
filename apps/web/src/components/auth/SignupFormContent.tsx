...
export default function SignupFormContent() {
  ...
  const inputClass =
    'block w-full rounded-xl border border-[#E4E3FF] bg-white py-2.5 pl-10 pr-10 text-[#1a161f] placeholder-[#8d8799] transition-colors focus:border-[#6E33EF]/50 focus:outline-none focus:ring-2 focus:ring-[#6E33EF]/25';

  const otpBoxClass =
    'h-12 w-10 sm:w-11 rounded-xl border border-[#E4E3FF] bg-white text-center text-lg font-semibold text-[#1a161f] transition-colors focus:border-[#6E33EF]/50 focus:outline-none focus:ring-2 focus:ring-[#6E33EF]/25';
  ...
  return (
    <div className="space-y-6">
        ...
        <>
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#E4E3FF]" />
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="bg-[#F5F4FF] px-2 text-[#5d5768]">or sign up with email</span>
            </div>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSignupSubmit}>
            ...
            <label className="flex items-start gap-2 text-sm text-[#5d5768] cursor-pointer">
              <input
                ...
                className="mt-0.5 rounded border-[#D4D2FF] bg-white text-[#6E33EF] focus:ring-[#6E33EF]/40"
              />
              <span>
                I agree to the{' '}
                <Link href="/terms" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#5A28D4] hover:text-[#9a3412] underline">
                  Terms of Service
                </Link>
              </span>
            </label>
            <label className="flex items-center gap-2 text-sm text-[#5d5768] cursor-pointer">
              <input
                ...
                className="rounded border-[#D4D2FF] bg-white text-[#6E33EF] focus:ring-[#6E33EF]/40"
              />
        ...
        <form className="space-y-4" onSubmit={handleVerifySubmit}>
          ...
          <div className="flex flex-col items-center gap-2 text-center">
            <button
              ...
              className="text-sm font-semibold text-[#5A28D4] hover:text-[#9a3412] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
            ...
            {lockoutActive ? (
              <p className="text-xs text-[#5d5768]">
                ...
                . Or{' '}
                <button type="button" onClick={openLogin} className="font-semibold text-[#5A28D4] hover:text-[#9a3412]">
                  log in
                </button>{' '}
                or use Google.
              </p>
          ...
          <button
            ...
            className="w-full text-sm text-[#5A28D4] hover:text-[#9a3412] transition-colors"
          >
      ...
      <p className="text-center text-sm text-[#5d5768]">
        ...
        <button type="button" onClick={openLogin} className="font-semibold text-[#5A28D4] hover:text-[#9a3412] transition-colors">
          Log in
        </button>
      </p>
    </div>
