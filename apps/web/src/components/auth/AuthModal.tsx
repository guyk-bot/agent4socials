...
function AuthModalInner() {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md rounded-[24px] border border-[#D4D2FF] bg-[#F5F4FF] p-8 shadow-[0_24px_60px_rgba(26,22,31,0.12)]"
      ...
      >
        ...
        <div className="text-center mb-6">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-neutral-950 p-2">
            <Image src={SITE_LOGO_SRC} alt="Agent4Socials" width={40} height={40} className="h-10 w-10 object-contain" />
          </div>
        </div>
        {modal === 'login' && (
