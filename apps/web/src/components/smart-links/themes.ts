...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    preview: 'linear-gradient(135deg, #1C9CFB 0%, #FA8DDF 100%)',
    design: {
      theme: 'sunset',
      bgType: 'gradient',
      bgGradient: 'linear-gradient(135deg, #1C9CFB 0%, #FA8DDF 50%, #E878C8 100%)',
      bgGradientColors: ['#1C9CFB', '#FA8DDF', '#E878C8'],
      fontFamily: 'Poppins, sans-serif',
      buttonStyle: 'pill',
      buttonColor: '#ffffff',
      buttonTextColor: '#FA8DDF',
      textColor: '#ffffff',
      animation: 'slide',
    },
  },
