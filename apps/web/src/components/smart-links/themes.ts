...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    preview: 'linear-gradient(135deg, #3EE2A7 0%, #6E33EF 100%)',
    design: {
      theme: 'sunset',
      bgType: 'gradient',
      bgGradient: 'linear-gradient(135deg, #3EE2A7 0%, #6E33EF 50%, #5A28D4 100%)',
      bgGradientColors: ['#3EE2A7', '#6E33EF', '#5A28D4'],
      fontFamily: 'Poppins, sans-serif',
      buttonStyle: 'pill',
      buttonColor: '#ffffff',
      buttonTextColor: '#6E33EF',
      textColor: '#ffffff',
      animation: 'slide',
    },
  },
