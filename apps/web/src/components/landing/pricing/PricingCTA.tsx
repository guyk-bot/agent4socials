  ...
  return (
    <section className="py-16 sm:py-20">
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
        <div className="rounded-3xl border border-[#C8E4FF] bg-gradient-to-b from-[#E8F4FF] to-white p-8 shadow-sm sm:p-12">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button
              type="button"
              onClick={onStartFree}
              className="w-full rounded-xl border border-[#C8E4FF] bg-white px-8 py-3.5 font-semibold text-[#E878C8] transition-all hover:border-[#FA8DDF] hover:bg-[#E8F4FF] sm:w-auto"
            >
              Start Free
            </button>
            <button
