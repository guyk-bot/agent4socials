          ...
          <div className="grid gap-6 sm:gap-8 sm:grid-cols-3">
            <div>
              ...
              <ul className="mt-4 space-y-3">
                ...
                <li><Link href="/#product" className="hover:text-[#53BEFA] transition-colors">Product</Link></li>
                <li><Link href="/#how-it-works" className="hover:text-[#53BEFA] transition-colors">How it works</Link></li>
                <li><Link href="/#faq" className="hover:text-[#53BEFA] transition-colors">FAQ</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3">
                ...
                <li><Link href="/data-deletion" className="hover:text-[#53BEFA] transition-colors">Data deletion</Link></li>
              </ul>
            </div>
          </div>
        </div>
