        ...
        >
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {accounts.map((a, i) => (
                <button
                  ...
                  className={`text-xs px-3 py-1.5 rounded-full border ${i === activeIdx ? 'bg-neutral-900 text-white border-neutral-900' : 'border-neutral-200 text-neutral-700 hover:bg-neutral-50'}`}
                >
          ...
          {videoPreviewSrc ? (
            <div className="mb-4 rounded-lg overflow-hidden bg-neutral-100 border border-neutral-200 aspect-[9/16] max-h-48 mx-auto flex items-center justify-center">
              <video src={videoPreviewSrc} className="max-h-full max-w-full object-contain" muted playsInline controls />
            </div>
          ) : null}
          ...
          {loadingCreator && !ci ? (
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-start gap-2 text-sm">
                ...
                <span>
                  {f.commercialDisclosureOn
                    ? 'I confirm the commercial disclosure above is accurate and I agree to TikTok’s terms for posting this content.'
                    : 'I agree to TikTok’s Music Usage Confirmation and terms for posting this content.'}
                </span>
              </label>
            </div>
          ) : null}
