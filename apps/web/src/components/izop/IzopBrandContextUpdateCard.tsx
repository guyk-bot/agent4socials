...
import { BrandContextSavedCelebration } from '@/components/izop/BrandContextSavedCelebration';
...
type Artifact = Extract<IzopArtifact, { type: 'brand_context_update' }>;
...
export function IzopBrandContextUpdateCard({
  artifact,
  messageId,
  artifactIndex,
  onArtifactResolved,
