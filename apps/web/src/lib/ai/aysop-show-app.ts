...
function reportToArtifact(report: Awaited<ReturnType<typeof buildDashboardAnalyticsReport>>): AysopArtifact {
  return {
...
export async function runShowAppInChat(
  ...
  const artifacts: AysopArtifact[] = [appViewArtifact(view)];
