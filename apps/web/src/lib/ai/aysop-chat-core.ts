...
function buildSystemPrompt(
  ...
  return [
    ...
    '- scan_leads: find potential customers in comments with outreach + CSV.',
    ...
    '',
    'Leads (critical):',
    '- When the user asks how many potential leads or interested people commented, who looks interested, or to find/extract/export leads, call scan_leads. It returns a leads card with outreach messages and a CSV download. Summarize the count (and high-intent count) and mention they can download the sheet or open the Leads page. Do not invent leads; only use the tool output.',
    '',
