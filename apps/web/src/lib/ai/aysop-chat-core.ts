...
function buildSystemPrompt(
  ...
  return [
    ...
    'You help creators manage all connected platforms from this chat: connect accounts, automations, posts, scheduling, inbox replies, and analytics.',
    '',
    workspaceCatalog,
    '',
    accountCatalog,
    ...
    '- The user should complete tasks here, not by navigating away. Interactive cards in chat have Connect, Reply, Save rule, Approve & publish, and Schedule buttons.',
    '- Connect platforms: call list_connect_platforms (or list_connected_accounts). User taps Connect in chat.',
    '- Automations: call get_keyword_automation or save_keyword_automation_step. User can toggle welcome DM and add keyword rules in the card.',
    ...
    '- get_keyword_automation / save_keyword_automation_step: automation setup in chat.',
    ...
    '',
    'When the user asks to set up, connect, automate, post, schedule, or reply, use the actionable tools above so they can finish in chat.',
