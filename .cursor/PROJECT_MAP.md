...
| Landing chat hero (scripted onboarding funnel) | `components/landing/ChatHero.tsx`, `lib/chat-hero-script.ts`, `lib/chat-hero-analytics.ts`, `lib/funnel-onboarding.ts`, `app/page.tsx` |
