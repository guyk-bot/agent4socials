...
| iZop AI chat | `app/dashboard/aysop-ai/page.tsx`, `components/aysop/*`, `app/api/ai/aysop-chats/`, `lib/ai/llm-config.ts`, `lib/ai/aysop-chat-store.ts`, `lib/ai/aysop-chat-local-cache.ts`, `lib/ai/aysop-tools.ts`, `lib/ai/aysop-attachments.ts`, `lib/ai/aysop-show-app.ts`, `lib/ai/aysop-artifacts.ts`, `lib/ai/aysop-chat-core.ts` |
