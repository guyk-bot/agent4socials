...
| iZop AI chat | `app/dashboard/aysop-ai/page.tsx`, `components/aysop/*`, `app/api/ai/aysop-chat/route.ts`, `app/api/ai/aysop-chats/`, `lib/ai/aysop-tools.ts`, `lib/ai/aysop-show-app.ts`, `lib/ai/aysop-artifacts.ts`, `lib/ai/aysop-chat-core.ts` |
