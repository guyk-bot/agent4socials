...
| LinkedIn OAuth consent UI (LinkedIn-style Allow screen, full page) | `app/connect/linkedin/consent/page.tsx`, `components/dashboard/LinkedInOAuthConsentScreen.tsx`, `lib/linkedin/oauth-consent-copy.ts`, `lib/linkedin/consent-member-avatar.ts`, `api/social/linkedin/consent-member-preview/route.ts`, `lib/linkedin/start-oauth.ts` |
...
| Connect flow UI (per-platform) | `apps/web/src/components/dashboard/ConnectView.tsx`, `TikTokConnectOptions.tsx` (`lib/tiktok/connect-options.ts`), `LinkedInConnectOptions.tsx` |
