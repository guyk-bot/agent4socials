...
| LinkedIn OAuth consent UI (LinkedIn-style Allow screen, app review preview) | `components/dashboard/LinkedInOAuthConsentScreen.tsx`, `lib/linkedin/oauth-consent-copy.ts`, `app/accounts/linkedin/consent-preview/page.tsx` |
