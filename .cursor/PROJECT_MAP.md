...
| Viral Trend Radar (YouTube outliers), Trending nav | `apps/web/src/app/dashboard/trending/page.tsx`, `apps/web/src/lib/trends/youtube-sweep.ts`, `apps/web/src/app/api/cron/niche-trends/route.ts`, `apps/web/src/app/api/trends/outliers/route.ts`, `apps/web/src/app/api/trends/sync-batch/route.ts` |
