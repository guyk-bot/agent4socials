...
| LinkedIn OAuth consent UI (identify → consent with photo/name → Allow connect) | `app/connect/linkedin/consent/page.tsx`, `LinkedInOAuthConsentScreen.tsx`, `LinkedInConsentSignInStep.tsx`, `api/social/linkedin/consent-preview/route.ts`, OAuth `step=identify` in `oauth/.../start` + callback |
...
| Account, brands, team invites (localStorage) | `apps/web/src/app/dashboard/account/page.tsx`, `apps/web/src/components/account/BrandTeamMembersSection.tsx`, `apps/web/src/components/account/ConnectedAccountsPanel.tsx`, brand map: `lib/brand-account-move.ts`, `AccountsCacheContext.tsx` |
...
| Landing chat hero (onboarding funnel + Q&A) | `components/landing/ChatHero.tsx`, `components/landing/funnel-demos/*`, `lib/chat-hero-script.ts`, `lib/landing-chat-knowledge.ts`, `lib/landing-chat-respond.ts`, `app/api/landing/chat/route.ts`, `components/ZThinkingLoopAnimation.tsx`, `lib/chat-hero-analytics.ts`, `lib/funnel-onboarding.ts`, `app/page.tsx` |
...
| iZop AI chat | `app/dashboard/izop-ai/page.tsx`, `components/izop/*` (incl. `IzopComposerPostDraftCard.tsx`, `IzopComposerSessionDraftCard.tsx`, `ComposerOpenLink.tsx`), `app/api/ai/izop-chats/`, `lib/composer/platform-capabilities.ts`, `lib/composer/izop-composer-draft-bridge.ts`, `lib/ai/llm-config.ts`, `lib/ai/izop-chat-store.ts`, `lib/ai/izop-chat-local-cache.ts`, `lib/ai/izop-tools.ts`, `lib/ai/izop-attachments.ts`, `lib/ai/izop-show-app.ts`, `lib/ai/izop-artifacts.ts`, `lib/ai/izop-chat-core.ts`, `lib/ai/izop-chat-fast-path.ts` |
