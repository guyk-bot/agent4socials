...
| LinkedIn OAuth consent UI (LinkedIn-style Allow screen, full page) | `app/connect/linkedin/consent/page.tsx`, `components/dashboard/LinkedInOAuthConsentScreen.tsx`, `lib/linkedin/oauth-consent-copy.ts`, `lib/linkedin/start-oauth.ts` |
