...
| Inbox | `apps/web/src/app/dashboard/inbox/page.tsx`, `api/inbox/bootstrap/route.ts`, `api/social/accounts/[id]/conversations/`, `comments/`, `lib/inbox/inbox-comment-platforms.ts`, `lib/inbox/inbox-client-cache.ts`, `lib/inbox/enrich-conversations-from-messages.ts` |
