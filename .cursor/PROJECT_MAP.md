...
| Landing chat hero (scripted onboarding funnel) | `components/landing/ChatHero.tsx`, `components/landing/funnel-demos/*`, `lib/chat-hero-script.ts`, `lib/chat-hero-analytics.ts`, `lib/funnel-onboarding.ts`, `lib/funnel-feature-pages.ts`, `app/features/[slug]/page.tsx`, `app/page.tsx` |
