...
- `automation/*`, `cron/*` (scheduled posts, metric snapshots, comment automation, **dm-first-welcome** first incoming DM sweep, migrations, email). **Suggested intervals:** `docs/CRON_SCHEDULES.md`.
