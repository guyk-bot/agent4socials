...
| Dashboard subpages | `dashboard/accounts/`, `dashboard/inbox/`, `dashboard/analytics/`, `dashboard/console/` (summary URL redirects), `dashboard/smart-links/`, `dashboard/automation/`, `settings/` | |
